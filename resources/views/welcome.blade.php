<x-app-layout>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 ">
                ...
                <div class="flex justify-center md:justify-start md:order-first items-center ">
                    ...
                    <div class="flex-col items-center text-center md:text-start pt-5 pb-10 px-2">
                        ...
                        <h3 class="text-3xl mt-10 font-bold dark:text-white ">Hello</h3>


                        <h2 class="text-4xl my-2 font-bold dark:text-white ">My name is <span
                                class="text-blue-600 dark:text-blue-500">Sourov Biswas</span></h2>

                        <p class="text-base my-2 text-gray-900 dark:text-white">Web developer, WordPress Expert. App
                            developer! We build Website you want!</p>
    ...
    <section class="bg-gray-200 dark:bg-gray-800 px-2">
        <div class="container mx-auto ">
            <div class="py-14">
                <h2 class="text-2xl  font-medium dark:text-white ">Things i do</h2>
                <p class="text-base my-2 text-gray-900 dark:text-white">Here is some list of my service that I provide
                    with MONEY back guarantee.</p>
    ...
    <section class="bg-gray-100 dark:bg-gray-900 px-2">
        ...
        <div class="container mx-auto py-14">
            <h2 class="text-2xl font-medium dark:text-white ">Languages I speak</h2>
    ...
    <section class="bg-gray-200 dark:bg-gray-800 px-2">
        <div class="container mx-auto ">
            <div class="py-14">
                ...
                <x-posts.post-grid classes="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6" :posts="$posts"
